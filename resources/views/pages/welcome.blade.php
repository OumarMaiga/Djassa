<x-app-layout>
    ...
    <div class="p-2 md:p-4 lg:p-4 md:ml-72 mt-24" id="container">
        ...
        <h2 class="text-md md:text-lg lg:text-xl mt-5 font-bold text-black">Les offres de la semaine dans les magasins</h2>
        ...
        <div style="display:flex; justify-content:center; align-items:center; margin-top:4%">
            <button id="more-products" class="text-[#ec6333] border-2 border-solid border-orange-600 md:px-8 md:py-1 px-16 py-3 rounded-lg text-base font-extrabold text-center">
                Afficher plus
            </button>
        </div>
