<x-app-layout>
    ...
    <div style="background:#F6F6F6; width:16rem; height:100vh; display:block; position:fixed; top:0; bottom:0; left:0;">
        ...
        <p class="text-sm font-normal text-black ml-4 mt-3 hover:bg-gray-800 hover:cursor-pointer">Fruits & Légumes</p>
        <p class="text-sm font-normal text-black ml-4 mt-3 hover:bg-gray-800 hover:cursor-pointer">Viandes & Poissons</p>
        <p class="text-sm font-normal text-black ml-4 mt-3 hover:bg-gray-800 hover:cursor-pointer">Produits laitiers et oeufs</p>
        <p class="text-sm font-normal text-black ml-4 mt-3 hover:bg-gray-800 hover:cursor-pointer">Boulangerie & Pâtisserie</p>

        <hr class="border-gray-800 mt-3 mb-3" style="margin-right:1rem; margin-left:1rem" />

        <p class="text-sm font-normal text-black ml-4 mt-3 hover:bg-gray-800 hover:cursor-pointer">Epicerie sucrée</p>
        <p class="text-sm font-normal text-black ml-4 mt-3 hover:bg-gray-800 hover:cursor-pointer">Epicerie salée</p>
        <p class="text-sm font-normal text-black ml-4 mt-3 hover:bg-gray-800 hover:cursor-pointer">Surgelés</p>
        <p class="text-sm font-normal text-black ml-4 mt-3 hover:bg-gray-800 hover:cursor-pointer">Boissons, Café & Thé</p>
        <p class="text-sm font-normal text-black ml-4 mt-3 hover:bg-gray-800 hover:cursor-pointer">Vins, Bières & Spititueux</p>

        <hr class="border-gray-800 mt-3 mb-3" style="margin-right:1rem; margin-left:1rem" />

        <p class="text-sm font-normal text-black ml-4 mt-3 hover:bg-gray-800 hover:cursor-pointer">Bébés & Enfants</p>
        <p class="text-sm font-normal text-black ml-4 mt-3 hover:bg-gray-800 hover:cursor-pointer">Hygiène & Beauté</p>
        <p class="text-sm font-normal text-black ml-4 mt-3 hover:bg-gray-800 hover:cursor-pointer">Entretien & Nettoyage</p>
        <p class="text-sm font-normal text-black ml-4 mt-3 hover:bg-gray-800 hover:cursor-pointer">Maisons & Equipements</p>
        <p class="text-sm font-normal text-black ml-4 mt-3 hover:bg-gray-800 hover:cursor-pointer">Vêtements & Accessoires</p>
